...
**注意事项**：本文档介绍人员选择-单选组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[人员选择-单选](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/single-select-user-picker)。
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/d85b31ecc22aac31e96f03611c115c30_JTuavGnynE.png?height=195&lazyload=true&maxWidth=500&width=819)
...
**注意事项**：人员选择-单选组件一般包含多个选项，因此你需配置自定义回传参数，以区分用户提交的是哪个选项。详情参考[配置卡片交互](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configuring-card-interactions)。
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/d85b31ecc22aac31e96f03611c115c30_q5kjDHzs72.png?height=195&lazyload=true&maxWidth=500&width=819)
```json
{
    "schema": "2.0",
    "body": {
