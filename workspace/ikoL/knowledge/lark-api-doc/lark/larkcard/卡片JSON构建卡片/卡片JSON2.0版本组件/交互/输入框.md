...
**注意事项**：- 本文档介绍输入框组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[输入框](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/input)。

-  要结合使用输入框组件与[按钮](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/interactive-components/button)组件，你需将输入框组件与按钮组件内嵌于[表单容器](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-components/containers/form-container)中。

![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/5678dab3ae875312a7b55b18067790ca_EUyzl1K2LS.png?height=565&lazyload=true&maxWidth=300&width=696)
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/5678dab3ae875312a7b55b18067790ca_8gk7UBwHfi.png?height=565&lazyload=true&maxWidth=400&width=696)
