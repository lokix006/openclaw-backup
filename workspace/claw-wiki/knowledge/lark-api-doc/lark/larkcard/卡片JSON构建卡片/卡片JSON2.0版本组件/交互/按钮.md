...
**注意事项**：本文档介绍按钮组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[按钮](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/button)。
