...
**注意事项**：本文档介绍日期时间选择器组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[日期时间选择器](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/date-time-picker)。
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ce9b460a1ec219bdd4481fc7fb80463d_2IrvXFZhDp.png?height=188&lazyload=true&maxWidth=400&width=559)
...
disabled | 否 | Boolean | false | 是否禁用该日期时间选择器。该属性仅支持Lark V7.4 及以上版本的客户端。可选值：<br>- true：禁用日期时间选择器组件<br>- false：日期时间选择器组件保持可用状态
...
behaviors | 是 | Struct | / | 配置交互类型和具体交互行为。详情参考[配置卡片交互](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configuring-card-interactions)中 behaviors 的字段说明。日期时间选择器支持配置回传交互（callback）。
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/ce9b460a1ec219bdd4481fc7fb80463d_caioJ5K6gF.png?height=188&lazyload=true&maxWidth=400&width=559)
