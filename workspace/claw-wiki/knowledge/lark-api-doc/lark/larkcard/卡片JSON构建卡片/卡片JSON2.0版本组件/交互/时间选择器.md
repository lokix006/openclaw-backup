...
**注意事项**：本文档介绍时间选择器组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[时间选择器](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/time-selector)。
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/06e975e8c8296319e6c3ed1dc4f9d3a5_F8K0yHFkdG.png?height=188&lazyload=true&maxWidth=400&width=560)
...
disabled | 否 | Boolean | false | 是否禁用该时间选择器。该属性仅支持Lark V7.4 及以上版本的客户端。可选值：<br>- true：禁用时间选择器组件<br>- false：时间选择器组件保持可用状态
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/06e975e8c8296319e6c3ed1dc4f9d3a5_9wvv0E6mVS.png?height=188&lazyload=true&maxWidth=400&width=560)
