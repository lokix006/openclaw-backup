...
**注意事项**：本文档介绍折叠按钮组组件的 JSON 2.0 结构和相关属性。了解 1.0 结构和属性，参考[折叠按钮组](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/overflow)。
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/dded93a79c281088c33102b2af4fea31_ubaZ7yDL26.png?height=206&lazyload=true&maxWidth=500&width=847)
        ...
        "elements": [
            {
                ...
                "options": [
                    ...
                    { // 为按钮添加文本。
                        ...
                        "multi_url": { // 为按钮添加跳转链接。
                            "url": "https://open.larksuite.com/document/home/index", // 兜底的跳转地址。
                            "pc_url": "",
                            "ios_url": "",
                            "android_url": ""
                        },
...
**注意事项**：如果折叠按钮组中包含多个按钮组件，你需配置自定义回传参数，以区分用户点击的是哪个按钮。详情参考[配置卡片交互](https://open.larksuite.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/configuring-card-interactions)。
...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/dded93a79c281088c33102b2af4fea31_UTEbSh584a.png?height=206&lazyload=true&maxWidth=500&width=847)
```json
{
    "schema": "2.0",
    "config": {
