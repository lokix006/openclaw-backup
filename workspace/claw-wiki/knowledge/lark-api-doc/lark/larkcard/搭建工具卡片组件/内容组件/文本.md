...
![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/10aeeb715dec02d163da671a62352ab4_f6VNMHhh7S.png?height=1316&lazyload=true&maxWidth=600&width=2882)

- lark_md 模式：支持部分 Markdown 语法的文本内容

![](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/affffe7344a1e6f36ac61d872e845705_fn8Bt364NG.png?height=1382&lazyload=true&maxWidth=600&width=2882)
...
参数 | 是否必须 | 类型 | 说明
---|---|---|---
tag | 是 | String | 文本元素的标签。两种模式的固定取值：<br>- plain_text：普通文本内容。<br>- lark_md：支持部分 Markdown 语法的文本内容。关于 Markdown 语法的详细介绍，可参见 [Markdown](https://open.larksuite.com/document/ukTMukTMukTM/uADOwUjLwgDM14CM4ATN#abc9b025)。
...
![image.png](//sf16-sg.larksuitecdn.com/obj/open-platform-opendoc-sg/783016ec1a9a53f24cdb065510da9793_brQZKkqxGm.png?height=186&lazyload=true&maxWidth=600&width=1206)
